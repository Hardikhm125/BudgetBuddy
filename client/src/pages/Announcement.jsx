...
import ig from "../assets/announcement-images/Announcement.jpeg";
...
export const Announcement = () => {  
  ...
  return (
    ...
    >
      <div className="card-body d-flex flex-column text-white md-4">
        <h3 className="md-4 card-title mt-auto mb-2" style={{
            color: "black",
            background:"white"
          }}>{projectName}</h3>
        <h5 className="md-4" style={{
            color: "black",
            background: "white"
          }}>{managerName}</h5>
