      ...
      <div className="row">
        ...
        <div className="col-9">
          <div ref={pdfRef} id="report">
            <div
              className="display-6 shadow-lg rounded p-3 fw-semibold text-light"
              style={{ background: "linear-gradient(to right, #333333, #cccccc)" }}
            >
              {project?.name}
            </div>
            <div
              className=" mt-3 display-8 p-2"
            ...
            <div className="team p-2">
              <div className="">
                <div
                  ...
                  style={{ background: "linear-gradient(to right, #333333, #cccccc)" }}
                >
                  <div className="display-8 fw-normal">Manager</div>
                </div>
              ...
              <div
                ...
                style={{ background: "linear-gradient(to right, #333333, #cccccc)" }}
              >
                <div className="display-6 fw-normal">Employees</div>
              </div>
              <div>
                <ol className="list-group mt-3 list-group-numbered">
            ...
            >
              <div
                ...
                style={{ background: "linear-gradient(to right, #333333, #cccccc)" }}
              >
                <h3 className="display-8 fw-normal p-2">
          ...
          >
            <div
              ...
              style={{ background: "linear-gradient(to right, #333333, #cccccc)" }}
            >
              <h3 className="mb-2 p-2 display-8 fw-normal">All Expenses </h3>
            </div>
            <div className="expense-table ms-5 mb-4">
              <ExpenseTable />
            </div>
